...
random_win_message=["Oh no! I lost. But I will win the next match","Oops! I lost. I will see you in the next round", "You won this one, so you better watch out next time "]
random_Tie_message=["Its a tie, but i will win the next one", "Its booring! let's play another round"] 
random_lost_message=["Hahah! I won", "GG! I won hope you have better luck next time!", "Lucky me! it's my day, let's have another round"]
